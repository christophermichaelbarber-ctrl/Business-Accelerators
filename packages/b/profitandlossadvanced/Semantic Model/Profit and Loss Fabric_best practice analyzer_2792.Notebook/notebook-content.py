...
dataset = "Profit and Loss Fabric" # Enter the name or ID of the semantic model
workspace = "GitIntegrationFabricTrial" # Enter the workspace name or ID in which the semantic model exists
